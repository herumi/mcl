...
mclb_mulUnitTbl:
_mclb_mulUnitTbl:
.global mclb_mulUnit0
.global _mclb_mulUnit0
mclb_mulUnit0:
_mclb_mulUnit0:
.quad 0
.global mclb_mulUnit1
.global _mclb_mulUnit1
mclb_mulUnit1:
_mclb_mulUnit1:
.quad mclb_mulUnit_fast1
.global mclb_mulUnit2
.global _mclb_mulUnit2
mclb_mulUnit2:
_mclb_mulUnit2:
.quad mclb_mulUnit_fast2
.global mclb_mulUnit3
.global _mclb_mulUnit3
mclb_mulUnit3:
_mclb_mulUnit3:
.quad mclb_mulUnit_fast3
.global mclb_mulUnit4
.global _mclb_mulUnit4
mclb_mulUnit4:
_mclb_mulUnit4:
.quad mclb_mulUnit_fast4
.global mclb_mulUnit5
.global _mclb_mulUnit5
mclb_mulUnit5:
_mclb_mulUnit5:
.quad mclb_mulUnit_fast5
.global mclb_mulUnit6
.global _mclb_mulUnit6
mclb_mulUnit6:
_mclb_mulUnit6:
.quad mclb_mulUnit_fast6
.global mclb_mulUnit7
.global _mclb_mulUnit7
mclb_mulUnit7:
_mclb_mulUnit7:
.quad mclb_mulUnit_fast7
.global mclb_mulUnit8
.global _mclb_mulUnit8
mclb_mulUnit8:
_mclb_mulUnit8:
.quad mclb_mulUnit_fast8
.global mclb_mulUnit9
.global _mclb_mulUnit9
mclb_mulUnit9:
_mclb_mulUnit9:
.quad mclb_mulUnit_fast9
.global mclb_mulUnitAddTbl
.global _mclb_mulUnitAddTbl
mclb_mulUnitAddTbl:
_mclb_mulUnitAddTbl:
.global mclb_mulUnitAdd0
.global _mclb_mulUnitAdd0
mclb_mulUnitAdd0:
_mclb_mulUnitAdd0:
.quad 0
.global mclb_mulUnitAdd1
.global _mclb_mulUnitAdd1
mclb_mulUnitAdd1:
_mclb_mulUnitAdd1:
.quad mclb_mulUnitAdd_fast1
.global mclb_mulUnitAdd2
.global _mclb_mulUnitAdd2
mclb_mulUnitAdd2:
_mclb_mulUnitAdd2:
.quad mclb_mulUnitAdd_fast2
.global mclb_mulUnitAdd3
.global _mclb_mulUnitAdd3
mclb_mulUnitAdd3:
_mclb_mulUnitAdd3:
.quad mclb_mulUnitAdd_fast3
.global mclb_mulUnitAdd4
.global _mclb_mulUnitAdd4
mclb_mulUnitAdd4:
_mclb_mulUnitAdd4:
.quad mclb_mulUnitAdd_fast4
.global mclb_mulUnitAdd5
.global _mclb_mulUnitAdd5
mclb_mulUnitAdd5:
_mclb_mulUnitAdd5:
.quad mclb_mulUnitAdd_fast5
.global mclb_mulUnitAdd6
.global _mclb_mulUnitAdd6
mclb_mulUnitAdd6:
_mclb_mulUnitAdd6:
.quad mclb_mulUnitAdd_fast6
.global mclb_mulUnitAdd7
.global _mclb_mulUnitAdd7
mclb_mulUnitAdd7:
_mclb_mulUnitAdd7:
.quad mclb_mulUnitAdd_fast7
.global mclb_mulUnitAdd8
.global _mclb_mulUnitAdd8
mclb_mulUnitAdd8:
_mclb_mulUnitAdd8:
.quad mclb_mulUnitAdd_fast8
.global mclb_mulUnitAdd9
.global _mclb_mulUnitAdd9
mclb_mulUnitAdd9:
_mclb_mulUnitAdd9:
.quad mclb_mulUnitAdd_fast9
.text
.align 16
.global mclb_add0
.global _mclb_add0
...
ret 
.align 16
.global mclb_disable_fast
.global _mclb_disable_fast
mclb_disable_fast:
_mclb_disable_fast:
lea mclb_mulUnit1(%rip), %rdx
lea mclb_mulUnit_slow1(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit2(%rip), %rdx
lea mclb_mulUnit_slow2(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit3(%rip), %rdx
lea mclb_mulUnit_slow3(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit4(%rip), %rdx
lea mclb_mulUnit_slow4(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit5(%rip), %rdx
lea mclb_mulUnit_slow5(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit6(%rip), %rdx
lea mclb_mulUnit_slow6(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit7(%rip), %rdx
lea mclb_mulUnit_slow7(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnit8(%rip), %rdx
lea mclb_mulUnit_slow8(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd1(%rip), %rdx
lea mclb_mulUnitAdd_slow1(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd2(%rip), %rdx
lea mclb_mulUnitAdd_slow2(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd3(%rip), %rdx
lea mclb_mulUnitAdd_slow3(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd4(%rip), %rdx
lea mclb_mulUnitAdd_slow4(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd5(%rip), %rdx
lea mclb_mulUnitAdd_slow5(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd6(%rip), %rdx
lea mclb_mulUnitAdd_slow6(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd7(%rip), %rdx
lea mclb_mulUnitAdd_slow7(%rip), %rax
mov %rax, (%rdx)
lea mclb_mulUnitAdd8(%rip), %rdx
lea mclb_mulUnitAdd_slow8(%rip), %rax
mov %rax, (%rdx)
ret 
