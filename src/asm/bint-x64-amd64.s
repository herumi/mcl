...
jmp mclb_mul_fast9
.align 16
.global mclb_mulLow_fast1
.global _mclb_mulLow_fast1
mclb_mulLow_fast1:
_mclb_mulLow_fast1:
mov %rdx, %r11
mov (%rsi), %rax
...
ret
.align 16
.global mclb_mulLow_fast2
.global _mclb_mulLow_fast2
mclb_mulLow_fast2:
_mclb_mulLow_fast2:
mov %rdx, %r11
mov (%rsi), %rdx
...
ret
.align 16
.global mclb_mulLow_fast3
.global _mclb_mulLow_fast3
mclb_mulLow_fast3:
_mclb_mulLow_fast3:
mov %rdx, %r11
mov (%rsi), %rdx
...
ret
.align 16
.global mclb_mulLow_fast4
.global _mclb_mulLow_fast4
mclb_mulLow_fast4:
_mclb_mulLow_fast4:
mov %rdx, %r11
mov (%rsi), %rdx
...
ret
.align 16
.global mclb_mulLow_fast5
.global _mclb_mulLow_fast5
mclb_mulLow_fast5:
_mclb_mulLow_fast5:
push %rbx
mov %rdx, %r11
...
ret
.align 16
.global mclb_mulLow_fast6
.global _mclb_mulLow_fast6
mclb_mulLow_fast6:
_mclb_mulLow_fast6:
push %rbx
push %rbp
...
ret
.align 16
.global mclb_mulLow_fast7
.global _mclb_mulLow_fast7
mclb_mulLow_fast7:
_mclb_mulLow_fast7:
push %rbx
push %rbp
...
ret
.align 16
.global mclb_mulLow_fast8
.global _mclb_mulLow_fast8
mclb_mulLow_fast8:
_mclb_mulLow_fast8:
push %rbx
push %rbp
...
ret
.align 16
.global mclb_mulLow_fast9
.global _mclb_mulLow_fast9
mclb_mulLow_fast9:
_mclb_mulLow_fast9:
push %rbx
push %rbp
