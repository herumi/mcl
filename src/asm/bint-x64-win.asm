; for masm (ml64.exe)
_data segment
public mclb_mulUnitTbl
mclb_mulUnitTbl:
public mclb_mulUnit0
mclb_mulUnit0:
dq 0
public mclb_mulUnit1
mclb_mulUnit1:
dq mclb_mulUnit_fast1
public mclb_mulUnit2
mclb_mulUnit2:
dq mclb_mulUnit_fast2
public mclb_mulUnit3
mclb_mulUnit3:
dq mclb_mulUnit_fast3
public mclb_mulUnit4
mclb_mulUnit4:
dq mclb_mulUnit_fast4
public mclb_mulUnit5
mclb_mulUnit5:
dq mclb_mulUnit_fast5
public mclb_mulUnit6
mclb_mulUnit6:
dq mclb_mulUnit_fast6
public mclb_mulUnit7
mclb_mulUnit7:
dq mclb_mulUnit_fast7
public mclb_mulUnit8
mclb_mulUnit8:
dq mclb_mulUnit_fast8
public mclb_mulUnit9
mclb_mulUnit9:
dq mclb_mulUnit_fast9
public mclb_mulUnitAddTbl
mclb_mulUnitAddTbl:
public mclb_mulUnitAdd0
mclb_mulUnitAdd0:
dq 0
public mclb_mulUnitAdd1
mclb_mulUnitAdd1:
dq mclb_mulUnitAdd_fast1
public mclb_mulUnitAdd2
mclb_mulUnitAdd2:
dq mclb_mulUnitAdd_fast2
public mclb_mulUnitAdd3
mclb_mulUnitAdd3:
dq mclb_mulUnitAdd_fast3
public mclb_mulUnitAdd4
mclb_mulUnitAdd4:
dq mclb_mulUnitAdd_fast4
public mclb_mulUnitAdd5
mclb_mulUnitAdd5:
dq mclb_mulUnitAdd_fast5
public mclb_mulUnitAdd6
mclb_mulUnitAdd6:
dq mclb_mulUnitAdd_fast6
public mclb_mulUnitAdd7
mclb_mulUnitAdd7:
dq mclb_mulUnitAdd_fast7
public mclb_mulUnitAdd8
mclb_mulUnitAdd8:
dq mclb_mulUnitAdd_fast8
public mclb_mulUnitAdd9
mclb_mulUnitAdd9:
dq mclb_mulUnitAdd_fast9
_text segment
align 16
mclb_add0 proc
xor eax, eax
...
align 16
mclb_disable_fast proc
lea rdx, offset mclb_mulUnit1
lea rax, offset mclb_mulUnit_slow1
mov [rdx], rax
lea rdx, offset mclb_mulUnit2
lea rax, offset mclb_mulUnit_slow2
mov [rdx], rax
lea rdx, offset mclb_mulUnit3
lea rax, offset mclb_mulUnit_slow3
mov [rdx], rax
lea rdx, offset mclb_mulUnit4
lea rax, offset mclb_mulUnit_slow4
mov [rdx], rax
lea rdx, offset mclb_mulUnit5
lea rax, offset mclb_mulUnit_slow5
mov [rdx], rax
lea rdx, offset mclb_mulUnit6
lea rax, offset mclb_mulUnit_slow6
mov [rdx], rax
lea rdx, offset mclb_mulUnit7
lea rax, offset mclb_mulUnit_slow7
mov [rdx], rax
lea rdx, offset mclb_mulUnit8
lea rax, offset mclb_mulUnit_slow8
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd1
lea rax, offset mclb_mulUnitAdd_slow1
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd2
lea rax, offset mclb_mulUnitAdd_slow2
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd3
lea rax, offset mclb_mulUnitAdd_slow3
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd4
lea rax, offset mclb_mulUnitAdd_slow4
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd5
lea rax, offset mclb_mulUnitAdd_slow5
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd6
lea rax, offset mclb_mulUnitAdd_slow6
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd7
lea rax, offset mclb_mulUnitAdd_slow7
mov [rdx], rax
lea rdx, offset mclb_mulUnitAdd8
lea rax, offset mclb_mulUnitAdd_slow8
mov [rdx], rax
ret 
mclb_disable_fast endp
_text ends
end
