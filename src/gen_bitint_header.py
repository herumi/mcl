...
print('#if defined(MCL_BITINT_ASM) && (MCL_BITINT_ASM == 1)')
...
gen_switch('mulUnit', 'Unit', arg_p2u, 'mclb_mulUnit', param_u3, N)
gen_switch('mulUnitAdd', 'Unit', arg_p2u, 'mclb_mulUnitAdd', param_u3, N)
