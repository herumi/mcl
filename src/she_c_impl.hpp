...
/*
	set *m = v
	return 0 if success else -1 (v does not fit in mclInt, which may be int)
*/
static int setMclInt(mclInt *m, int64_t v)
{
	const mclInt t = (mclInt)v;
	if ((int64_t)t != v) return -1;
	*m = t;
	return 0;
}
