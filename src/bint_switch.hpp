// this code is generated by python3 src/gen_bint_header.py switch -n 6
#if MCL_BINT_ASM == 1
extern "C" {
...
Unit mclb_mulUnit18(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd18(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit19(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd19(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit20(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd20(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit21(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd21(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit22(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd22(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit23(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd23(Unit *z, const Unit *x, Unit y);
...
Unit mclb_mulUnit24(Unit *z, const Unit *x, Unit y);
Unit mclb_mulUnitAdd24(Unit *z, const Unit *x, Unit y);
...
u_ppu get_mulUnit(size_t n)
{
	...
	if (n == 17) return mclb_mulUnit17;
	if (n == 18) return mclb_mulUnit18;
	if (n == 19) return mclb_mulUnit19;
	if (n == 20) return mclb_mulUnit20;
	if (n == 21) return mclb_mulUnit21;
	if (n == 22) return mclb_mulUnit22;
	if (n == 23) return mclb_mulUnit23;
	if (n == 24) return mclb_mulUnit24;
#endif // MCL_SIZEOF_UNIT == 4
#else // MCL_BINT_ASM == 1
	...
	if (n == 17) return mulUnitT<17>;
	if (n == 18) return mulUnitT<18>;
	if (n == 19) return mulUnitT<19>;
	if (n == 20) return mulUnitT<20>;
	if (n == 21) return mulUnitT<21>;
	if (n == 22) return mulUnitT<22>;
	if (n == 23) return mulUnitT<23>;
	if (n == 24) return mulUnitT<24>;
#endif // MCL_SIZEOF_UNIT == 4
#endif // MCL_BINT_ASM == 1
	assert(0); // n is out of range (see MCL_BINT_MUL_N in include/mcl/config.hpp)
	return 0;
...
u_ppu get_mulUnitAdd(size_t n)
{
	...
	if (n == 17) return mclb_mulUnitAdd17;
	if (n == 18) return mclb_mulUnitAdd18;
	if (n == 19) return mclb_mulUnitAdd19;
	if (n == 20) return mclb_mulUnitAdd20;
	if (n == 21) return mclb_mulUnitAdd21;
	if (n == 22) return mclb_mulUnitAdd22;
	if (n == 23) return mclb_mulUnitAdd23;
	if (n == 24) return mclb_mulUnitAdd24;
#endif // MCL_SIZEOF_UNIT == 4
#else // MCL_BINT_ASM == 1
	...
	if (n == 17) return mulUnitAddT<17>;
	if (n == 18) return mulUnitAddT<18>;
	if (n == 19) return mulUnitAddT<19>;
	if (n == 20) return mulUnitAddT<20>;
	if (n == 21) return mulUnitAddT<21>;
	if (n == 22) return mulUnitAddT<22>;
	if (n == 23) return mulUnitAddT<23>;
	if (n == 24) return mulUnitAddT<24>;
#endif // MCL_SIZEOF_UNIT == 4
#endif // MCL_BINT_ASM == 1
	assert(0); // n is out of range (see MCL_BINT_MUL_N in include/mcl/config.hpp)
	return 0;
