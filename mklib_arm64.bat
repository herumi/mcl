...
if "%1"=="dll" (
clang-cl -target aarch64-pc-windows-msvc /LD %OBJ% /Fe:bin\mclbn.dll /link "%CLANG_RT_PATH%\clang_rt.builtins-aarch64.lib" msvcrt.lib kernel32.lib /LIBPATH:"%WindowsSdkDir%Lib\%WindowsSDKVersion%\um\arm64" /LIBPATH:"%WindowsSdkDir%Lib\%WindowsSDKVersion%\ucrt\arm64"
) else (
