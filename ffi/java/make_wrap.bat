...
cl /MT /DNOMINMAX /LD /Ox /DNDEBUG /EHsc /DMCL_MSM=0 %NAME%_wrap.cxx %TOP_DIR%/src/fp.cpp bint-x64-win.obj -I%JAVA_INCLUDE% -I%JAVA_INCLUDE%\win32 -I%TOP_DIR%/include -I%TOP_DIR%/../cybozulib/include /link /OUT:%TOP_DIR%/bin/mcl%LIBNAME%java.dll
