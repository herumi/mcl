...
GEN_EXE=src/gen
# base{32,64}.ll are generated by the Python tool src/gen.py (s_xbyak_llvm.py).
# src/gen.cpp / src/llvm_gen.hpp are kept for reference; building $(GEN_EXE) is
# no longer required. -ver is accepted and ignored by gen.py.
